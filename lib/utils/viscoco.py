...
color1 = [(243,176,252),(243,176,252),(127,2,240),
    (240,176,0), (240,176,0), (127,2,240),
    #(240,2,127),(240,2,127),(240,2,127), (240,2,127), (240,2,127), 
    (0,255,255), (0,255,255),(0,255,255),
    (142, 209, 169),(142, 209, 169)]
    ...
    for y in range(ymaps):
        for x in range(xmaps):
            ...
            for joint, joint_vis in zip(joints, joints_vis):
                ...
                #if joint_vis[0]:
                    #cv2.circle(ndarr, (int(joint[0]), int(joint[1])), 2, ring_color[h], 1)
            ...
            for i, link_pair in enumerate(link_pairs):
                ...
                if joints_vis[link_pair[0]][0] and joints_vis[link_pair[1]][0] :
                    cv2.line(ndarr,(joints_dict[link_pair[0]][0],joints_dict[link_pair[0]][1]),(joints_dict[link_pair[1]][0],joints_dict[link_pair[1]][1]),link_pair[2],2,lw)
            k=k+1
    ...
    for i in range(batch_size):
        ...
        for j in range(num_joints):
            cv2.circle(resized_image,
                       ...
                       1, [0, 0, 255], 1)
            heatmap = heatmaps[j, :, :]#第几个关节的heatmap
            colored_heatmap = cv2.applyColorMap(heatmap, cv2.COLORMAP_JET)#伪色彩
            masked_image = colored_heatmap*0.7 + resized_image*0.3
            cv2.circle(masked_image,
                       (int(preds[i][j][0]), int(preds[i][j][1])),
                       1, [0, 0, 255], 1)#加了伪色彩的再加一次
        ...
        grid_image[height_begin:height_end, 0:heatmap_width, :] = resized_image#最后画原图
