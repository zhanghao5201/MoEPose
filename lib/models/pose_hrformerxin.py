...
class HighResolutionTransformer(nn.Module):
    ...
    STAGE3=dict(
      ...
      NUM_RESOLUTIONS= [[64, 64], [32, 32], [16, 16]],
    ...
    STAGE4=dict(
      ...
      NUM_RESOLUTIONS= [[64, 64], [32, 32], [16, 16],[8,8]],
    ...
    def init_weights(self, pretrained=''):
        ...
        if os.path.isfile(pretrained):
            ...
            logger.info('=>stuloading pretrained model {}'.format(pretrained))
...
def get_pose_net(cfg, is_train, **kwargs):
    model = HighResolutionTransformer(cfg, **kwargs)
